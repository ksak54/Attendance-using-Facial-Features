...
window = tk.Tk()
#helv36 = tk.Font(family='Times', size=36, weight='bold')
window.title("Face_Recogniser")

app = FullScreenApp(window)
background_image = tk.PhotoImage(file='neurons.png')
...
window.configure(background='#4dd2ff')
...
message = tk.Label(window, text="Face-Recognition-Based-Attendance-Management-System",
                   bg="#ffb3ff", fg="black", width=45, height=2, font=('times', 30, ' bold '))

message.place(x=200, y=20)

lbl = tk.Label(window, text="Enter ID", width=20, height=2,
               fg="black", bg="#4dd2ff", font=('times', 15, ' bold '))
lbl.place(x=400, y=200)

txt = tk.Entry(window, width=20, bg="#e6f9ff",
               fg="black", font=('times', 15, ' bold '))
txt.place(x=700, y=215)

lbl2 = tk.Label(window, text="Enter Name", width=20, fg="black",
                bg="#4dd2ff", height=2, font=('times', 15, ' bold '))
lbl2.place(x=400, y=300)

txt2 = tk.Entry(window, width=20, bg="#e6f9ff",
                fg="black", font=('times', 15, ' bold '))
txt2.place(x=700, y=315)

lbl3 = tk.Label(window, text="Notification : ", width=20, fg="black",
                bg="#4dd2ff", height=2, font=('times', 15, ' bold underline '))
lbl3.place(x=400, y=400)

message = tk.Label(window, text="", bg="#e6f9ff", fg="black", width=30,
                   height=2, activebackground="#e6f9ff", font=('times', 15, ' bold '))
...
message2 = tk.Label(window, text="", fg="black", bg="#e6f9ff",
...
takeImg = tk.Button(window, text="Take Images", command=TakeImages, fg="black", bg="#4dd2ff",
                    width=20, height=3, activebackground="#4d79ff", font=('times', 15, ' bold '))
takeImg.place(x=200, y=500)
trainImg = tk.Button(window, text="Train Images", command=TrainImages, fg="black",
                     bg="#4dd2ff", width=20, height=3, activebackground="#4d79ff", font=('times', 15, ' bold '))
trainImg.place(x=500, y=500)
trackImg = tk.Button(window, text="Recognize", command=TrackImages, fg="black",
                     bg="#4dd2ff", width=20, height=3, activebackground="#4d79ff", font=('times', 15, ' bold '))
